...
#include "ObjectiveFun2.h"


int ObjectiveFun2::IsParent(const IPv6Address& srcAddr,double rank)
{
...
double ObjectiveFun2::UpdateParent(double counter, int srID, const IPv6Address& srcAddr,int rank, const MACAddress& srcMACAddr)
{
    ParentStructure* rcv = new ParentStructure();
    rcv->srnode = srID;
...
double ObjectiveFun2::counterCal(int srID, double precount, int NumDio)
{
...
int ObjectiveFun2::counterSetting(int srID)
{
    //--begin--handling with counter cache, added 25th April
    ParentStructure* rcv = new ParentStructure();
    rcv->srnode = srID;
...
bool ObjectiveFun2::counterLessThan(const ParentStructure *a, const ParentStructure *b)
{
