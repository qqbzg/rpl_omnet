...
int nbFramesWithInterference1=0;
int nbFramesWithoutInterference1=0;

int nbFramesWithInterferencePartial1=0;
int nbFramesWithoutInterferencePartial1=0;

int nbFramesWithInterferenceDropped1=0;
int nbFramesWithoutInterferenceDropped1=0;
	...
	if (bFinishProcessing || bInteruptedProcessing) {
	    if (!bFinishProcessing && bInteruptedProcessing) {
	        if (currentSignal.getInterferenceCnt() > 0) {
                ...
                ++nbFramesWithInterferencePartial1;
	        }
	        else {
                ++nbFramesWithoutInterferencePartial;
                ++nbFramesWithoutInterferencePartial1;
	        }
	    }
...
simtime_t BaseDecider::processSignalEnd(airframe_ptr_t frame) {
	...
	if (pResult != NULL && pResult->isSignalCorrect() && !frame->hasBitError()) {
        ...
        if (currentSignal.getInterferenceCnt() > 0) {
            ...
            ++nbFramesWithInterference1;
        }
        else {
            ++nbFramesWithoutInterference;
            ++nbFramesWithoutInterference1;
        }
        ...
        if (currentSignal.getInterferenceCnt() > 0) {
            ...
            ++nbFramesWithInterferenceDropped1;
        }
        else {
            ++nbFramesWithoutInterferenceDropped;
            ++nbFramesWithoutInterferenceDropped1;
        }
        if (pMacPacket) {
...
//    EV<<"\n\n\nNode["<<myIndex<<"]. nbFramesWithoutInterference = "<<nbFramesWithoutInterference<<"    nbFramesWithInterference = "<<nbFramesWithInterference<<"    nbFramesWithInterferenceDropped = "<<nbFramesWithInterferenceDropped<<"    nbFramesWithoutInterferenceDropped = "<<nbFramesWithoutInterferenceDropped<<"\n\n\n";
    if (phy) {
...
int GetnbFramesWithInterference(){return nbFramesWithInterference1;}
int GetnbFramesWithoutInterference(){return nbFramesWithoutInterference1;}

int GetnbFramesWithInterferencePartial(){return nbFramesWithInterferencePartial1;}
int GetnbFramesWithoutInterferencePartial(){return nbFramesWithoutInterferencePartial1;}

int GetnbFramesWithInterferenceDropped(){return nbFramesWithInterferenceDropped1;}
int GetnbFramesWithoutInterferenceDropped() {return nbFramesWithoutInterferenceDropped1;}

void ResetNBFramesWithInterferenceDropped(){nbFramesWithInterferenceDropped1=0;}
void ResetNBFramesWithoutInterferenceDropped() {nbFramesWithoutInterferenceDropped1=0;}

void ResetnbFramesWithInterference(){nbFramesWithInterference1=0;}
void ResetnbFramesWithoutInterference(){nbFramesWithoutInterference1=0;}

void ResetnbFramesWithInterferencePartial(){nbFramesWithInterferencePartial1=0;}
void ResetnbFramesWithoutInterferencePartial(){nbFramesWithoutInterferencePartial1=0;}
