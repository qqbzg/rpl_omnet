...
int GetnbFramesWithInterference(void);
int GetnbFramesWithoutInterference(void);

int GetnbFramesWithInterferencePartial(void);
int GetnbFramesWithoutInterferencePartial(void);

int GetnbFramesWithInterferenceDropped(void);
int GetnbFramesWithoutInterferenceDropped(void);


void ResetnbFramesWithInterference(void);
void ResetnbFramesWithoutInterference(void);

void ResetNBFramesWithInterferenceDropped(void);
void ResetNBFramesWithoutInterferenceDropped(void);

void ResetnbFramesWithInterferencePartial(void);
void ResetnbFramesWithoutInterferencePartial(void);
