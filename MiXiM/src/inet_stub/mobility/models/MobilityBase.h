...
{
  public:
    bool UseRandomTopology;
    double GetX(void)  {return lastPosition.x;}  // My Function
    double GetY(void)  {return lastPosition.y;}  // My Function
    double GetZ(void)  {return lastPosition.z;}  // My Function
  ...
  protected:
    double x ;  // My variable
    double y ;  // My variable
    double z ;  // My variable
